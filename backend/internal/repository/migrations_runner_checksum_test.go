...
// The checksums below are real historical versions of each migration, computed
// the way applyMigrationsFS does (sha256 over TrimSpace'd content). Do not copy
// values out of migrationChecksumCompatibilityRules into these cases: that makes
// the test tautological and, as happened before, locks in a wrong value — nine
// rules were registered with sha256 over raw file bytes and these cases asserted
// those wrong values were "compatible" for as long as the rules were inert.
