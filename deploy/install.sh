...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/hongheshan-svg/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="hongheshan-svg/sub2api"
...
Documentation=https://github.com/hongheshan-svg/sub2api
